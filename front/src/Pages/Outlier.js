...
export default function Outlier() {
  return (
    <div className="h-screen bg-gray-100 p-4 flex items-center justify-center">
      ...
      <div className="bg-white w-full h-full shadow-lg p-4 flex flex-col space-y-4">
        ...
        <div className="flex flex-1 gap-4">
          ...
          <div className="flex flex-1 flex-col border border-gray-300 bg-gray-50 rounded-lg p-6 shadow">
            <h2 className="text-lg font-bold text-gray-700 ">이상치 유형별 차트</h2>
            {/* 이벤트별 그래프 컴포넌트를 추가 */}
            <AnomalyTypeCircleChart />
          </div>
          {/* 두 번째 영역: 지역별 이상치 갯수 */}
          <div className="flex flex-1 flex-col border border-gray-300 bg-gray-50 rounded-lg p-6 shadow">
            <h2 className="text-lg font-bold text-gray-700 ">허브별 이상치 발생 수</h2>
