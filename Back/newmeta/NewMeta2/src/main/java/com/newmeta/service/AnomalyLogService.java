...
public class AnomalyLogService {
    ...
    public Page<AnomalyDTO> getPagedAnomalyDetails(Pageable pageable) {
        log.info("📡 페이지네이션 이상치 로그 조회 요청: pageNumber={}, pageSize={}",
                 pageable.getPageNumber(), pageable.getPageSize());
        return anomalyLogRepo.findAllAnomalyDetails(pageable);
    }
